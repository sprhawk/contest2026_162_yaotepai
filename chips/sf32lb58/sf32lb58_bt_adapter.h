/****************************************************************************
 * chips/sf32lb58/sf32lb58_bt_adapter.h
 *
...
#ifndef __CHIPS_SF32LB58_SF32LB58_BT_ADAPTER_H
#define __CHIPS_SF32LB58_SF32LB58_BT_ADAPTER_H

#include <stdint.h>

typedef int (*sf32lb58_bt_rx_callback_t)(uint8_t *data, uint16_t len);
